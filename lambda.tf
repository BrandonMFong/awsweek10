...
data "aws_iam_policy_document" "lambda-iam-policy-1" {
  statement {
    ...
    resources = [
      "${aws_s3_bucket.ece592-week10-brando.arn}/*"
    ]
  }
}
...
resource "aws_iam_role_policy_attachment" "week10-lambda-automation-role" {
